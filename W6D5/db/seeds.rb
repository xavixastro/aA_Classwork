...
artwork_shares = ArtworkShare.create( 
  ...
  comments = Comment.create( 
    [{user_id: 3, artwork_id: 3, body:'Super Dope' },
    {user_id: 4, artwork_id: 3, body: 'Colors are amazing'},
    {user_id: 4, artwork_id: 4, body: 'What aggressive brush strokes'},
    {user_id: 2, artwork_id: 1, body: 'So emotional'},
    {user_id: 1, artwork_id: 2, body: 'A classsic masterpiece!'}]
    )
